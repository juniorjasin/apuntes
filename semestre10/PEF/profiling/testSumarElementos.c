...
int main(int argc, char *argv[])
{
    ...
    n = CrearMatriz(rows, cols);
    CargarMatriz(n, rows, cols);
    
    SumarElementos(m, n, rows, cols);
    ...
    assert(m[posicion_random1][posicion_random1] != n[posicion_random2][posicion_random2]);
